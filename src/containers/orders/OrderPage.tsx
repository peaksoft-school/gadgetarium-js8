...
import CanceledProducts from './tab-order-components/CanceledOrders'
import PendingOrders from './tab-order-components/PendingOrders'
import InProcessingOrders from './tab-order-components/InProcessingOrders'
import CourierOnTheWay from './tab-order-components/CourierOnTheWay'
