...
//             <Typography>Вы уверены, что хотите удалить товар пользователя</Typography>
//             <Typography>({fullName || "Don't have"})?</Typography>
//           </Typography>
//           <Box className="flex center gap2">
//             <ButtonStyled variant="outlined" className="cancel_button" onClick={handleClose}>
//               Отменить
//             </ButtonStyled>
//             <ButtonStyled variant="contained" className="logout_button" onClick={deleteOrder}>
//               Удалить
//             </ButtonStyled>
//           </Box>
//         </StyledModal>
