...
import AppTable from '../../../components/UI/table/ReusabletTable'
import ProductsDatePicker from '../../../components/admin/UI/date-picker/DatePicker'
import { styled } from '@mui/material'
import { getAllOrdersRequest } from '../../../api/order/orderService'
...
const InProcessingOrders = ({ queryParams, onFirstChange, onSecondChange }: Props) => {
  ...
  return (
    <div>
      ...
      <AppTable columns={columns} rows={order} getUniqueId={(value: any) => value} />
    </div>
  )
}
